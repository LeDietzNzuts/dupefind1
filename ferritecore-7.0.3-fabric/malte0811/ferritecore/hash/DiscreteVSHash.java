...
public class DiscreteVSHash implements Strategy<class_251> {
   public static final DiscreteVSHash INSTANCE = new DiscreteVSHash();

   public int hashCode(class_251 shape) {
   ...
   public boolean equals(class_251 a, class_251 b) {
      ...
      if (a == b) {
         ...
         if (a.getClass() != b.getClass()) {
            ...
            return accessA.getEndX() == accessB.getEndX()
               ...
               && this.equals((DiscreteVSAccess)accessA.getParent(), (DiscreteVSAccess)accessB.getParent());
