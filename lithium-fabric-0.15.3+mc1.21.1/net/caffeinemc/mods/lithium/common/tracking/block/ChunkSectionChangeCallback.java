...
public final class ChunkSectionChangeCallback {
      ...
      if (BlockListeningSection.class.isAssignableFrom(class_2826.class)) {
         ChunkStatusTracker.registerUnloadCallback((serverWorld, chunkPos) -> {
            ...
            for (int y = Pos.SectionYCoord.getMinYSection(serverWorld); y <= Pos.SectionYCoord.getMaxYSectionInclusive(serverWorld); y++) {
               class_4076 chunkSectionPos = class_4076.method_18676(x, y, z);
   ...
   public static ChunkSectionChangeCallback create(long sectionPos, class_1937 world) {
      ...
      ChunkSectionChangeCallback previous = (ChunkSectionChangeCallback)changeCallbacks.put(sectionPos, chunkSectionChangeCallback);
      if (previous != null) {
         previous.onChunkSectionInvalidated(class_4076.method_18677(sectionPos));
      }
