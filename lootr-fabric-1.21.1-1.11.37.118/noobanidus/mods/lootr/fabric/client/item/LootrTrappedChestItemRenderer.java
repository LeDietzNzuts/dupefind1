...
public class LootrTrappedChestItemRenderer extends class_756 implements DynamicItemRenderer {
   ...
   public LootrTrappedChestItemRenderer(class_824 pBlockEntityRenderDispatcher, class_5599 pEntityModelSet) {
      super(pBlockEntityRenderDispatcher, pEntityModelSet);
      this.blockEntityRenderDispatcher = pBlockEntityRenderDispatcher;
      this.tile = new LootrTrappedChestBlockEntity(class_2338.field_10980, LootrRegistry.getTrappedChestBlock().method_9564());
   }
