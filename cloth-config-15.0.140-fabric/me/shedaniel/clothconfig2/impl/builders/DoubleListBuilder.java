...
public class DoubleListBuilder extends AbstractRangeListBuilder<Double, DoubleListListEntry, DoubleListBuilder> {
   ...
   public DoubleListBuilder(class_2561 resetButtonKey, class_2561 fieldNameKey, List<Double> value) {
   ...
   public DoubleListBuilder setCellErrorSupplier(Function<Double, Optional<class_2561>> cellErrorSupplier) {
      return (DoubleListBuilder)super.setCellErrorSupplier(cellErrorSupplier);
   }

   public DoubleListBuilder setErrorSupplier(Function<List<Double>, Optional<class_2561>> errorSupplier) {
      this.errorSupplier = (Function<List<T>, Optional<class_2561>>)errorSupplier;
      return this;
   }
   ...
   public DoubleListBuilder setAddButtonTooltip(class_2561 addTooltip) {
      return (DoubleListBuilder)super.setAddButtonTooltip(addTooltip);
   }

   public DoubleListBuilder setRemoveButtonTooltip(class_2561 removeTooltip) {
   ...
   public DoubleListBuilder setTooltipSupplier(Function<List<Double>, Optional<class_2561[]>> tooltipSupplier) {
      return (DoubleListBuilder)super.setTooltipSupplier(tooltipSupplier);
   }

   public DoubleListBuilder setTooltipSupplier(Supplier<Optional<class_2561[]>> tooltipSupplier) {
      return (DoubleListBuilder)super.setTooltipSupplier(tooltipSupplier);
   }

   public DoubleListBuilder setTooltip(Optional<class_2561[]> tooltip) {
      return (DoubleListBuilder)super.setTooltip(tooltip);
   }

   public DoubleListBuilder setTooltip(class_2561... tooltip) {
      return (DoubleListBuilder)super.setTooltip(tooltip);
   }

   @NotNull
   public DoubleListListEntry build() {
      DoubleListListEntry entry = new DoubleListListEntry(
