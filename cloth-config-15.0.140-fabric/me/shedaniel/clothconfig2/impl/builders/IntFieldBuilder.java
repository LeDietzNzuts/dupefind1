...
public class IntFieldBuilder extends AbstractRangeFieldBuilder<Integer, IntegerListEntry, IntFieldBuilder> {
   public IntFieldBuilder(class_2561 resetButtonKey, class_2561 fieldNameKey, int value) {
   ...
   public IntFieldBuilder setErrorSupplier(Function<Integer, Optional<class_2561>> errorSupplier) {
   ...
   public IntFieldBuilder setTooltipSupplier(Function<Integer, Optional<class_2561[]>> tooltipSupplier) {
      return (IntFieldBuilder)super.setTooltipSupplier(tooltipSupplier);
   }

   public IntFieldBuilder setTooltipSupplier(Supplier<Optional<class_2561[]>> tooltipSupplier) {
      return (IntFieldBuilder)super.setTooltipSupplier(tooltipSupplier);
   }

   public IntFieldBuilder setTooltip(Optional<class_2561[]> tooltip) {
      return (IntFieldBuilder)super.setTooltip(tooltip);
   }

   public IntFieldBuilder setTooltip(class_2561... tooltip) {
      return (IntFieldBuilder)super.setTooltip(tooltip);
   }
   ...
   public IntegerListEntry build() {
      IntegerListEntry entry = new IntegerListEntry(
