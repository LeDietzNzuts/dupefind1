...
public class SimpleNetworkManager {
   ...
   public MessageType registerS2C(String id, MessageDecoder<BaseS2CMessage> decoder, List<PacketTransformer> transformers) {
      MessageType messageType = new MessageType(this, class_2960.method_60655(this.namespace, id), NetworkManager.s2c());
      if (Platform.getEnvironment() == Env.CLIENT) {
         NetworkManager.NetworkReceiver<class_9129> receiver = decoder.createReceiver();
   ...
   public MessageType registerC2S(String id, MessageDecoder<BaseC2SMessage> decoder, List<PacketTransformer> transformers) {
      MessageType messageType = new MessageType(this, class_2960.method_60655(this.namespace, id), NetworkManager.c2s());
      NetworkManager.NetworkReceiver<class_9129> receiver = decoder.createReceiver();
