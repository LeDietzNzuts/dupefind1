...
public class NormalPlanes {
   ...
   private NormalPlanes(class_4076 sectionPos, AlignableNormal normal) {
      this.sectionPos = sectionPos;
      this.normal = normal;
   }

   public NormalPlanes(class_4076 sectionPos, Vector3fc normal) {
      this(sectionPos, AlignableNormal.fromUnaligned(normal));
   }

   public NormalPlanes(class_4076 sectionPos, int alignedDirection) {
   ...
   public void prepareIntegration() {
      if (this.relativeDistances != null) {
         ...
         this.baseDistance = this.normal.dot(this.sectionPos.method_19527(), this.sectionPos.method_19528(), this.sectionPos.method_19529());
