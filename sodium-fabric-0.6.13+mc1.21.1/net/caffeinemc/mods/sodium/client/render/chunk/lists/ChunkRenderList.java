...
public class ChunkRenderList {
   ...
   public void sortSections(class_4076 cameraPos, int[] sortItems) {
      int cameraX = class_3532.method_15340(cameraPos.method_10263() - this.region.getChunkX(), 0, 7);
      int cameraY = class_3532.method_15340(cameraPos.method_10264() - this.region.getChunkY(), 0, 3);
      int cameraZ = class_3532.method_15340(cameraPos.method_10260() - this.region.getChunkZ(), 0, 7);
