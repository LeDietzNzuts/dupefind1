...
public class FerriteCorePostProcess {
   ...
   public static <O, S extends class_2688<O, S>> void postProcess(class_2689<O, S> state) {
      if (willPostProcess) {
         try {
            if (state.method_11659().size() == 0) {
               UnmodifiableIterator e = state.method_11662().iterator();

               while (e.hasNext()) {
                  S holder = (S)e.next();
                  Object table = (Object)theTable.invoke((class_2688)holder);
                  toKeyIndex.invoke((Object)table, (Object2IntMap)EMPTY_MAP);
               }
            }
   ...
   static {
      ...
      try {
         ...
         field = class_2688.class.getDeclaredField("ferritecore_globalTable");
         field.setAccessible(true);
