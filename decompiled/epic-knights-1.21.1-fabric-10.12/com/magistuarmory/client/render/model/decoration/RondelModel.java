...
public class RondelModel<T extends class_1309> extends ArmorDecorationModel<T> {
   public RondelModel(class_630 root) {
      super(root);
   }
   ...
   public static class_5607 createLayer() {
      ...
      partdefinition.method_32117(
         "right_arm",
         class_5606.method_32108().method_32101(0, 0).method_32096().method_32098(-7.5F, -7.0F, -3.4F, 16.0F, 16.0F, 0.0F, new class_5605(0.0F)),
         class_5603.field_27701
      );
      partdefinition.method_32117(
         "left_arm",
         class_5606.method_32108().method_32101(0, 0).method_32098(-8.5F, -7.0F, -3.4F, 16.0F, 16.0F, 0.0F, new class_5605(0.0F)),
         class_5603.field_27701
      );
