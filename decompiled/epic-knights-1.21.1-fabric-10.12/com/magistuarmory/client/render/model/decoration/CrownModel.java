...
public class CrownModel<T extends class_1309> extends ArmorDecorationModel<T> {
   public CrownModel(class_630 root) {
      super(root);
   }
   ...
   public static class_5607 createLayer() {
      ...
      class_5610 head = partdefinition.method_32117(
         "head",
         class_5606.method_32108().method_32101(0, 0).method_32098(-5.0F, -9.0F, -5.0F, 10.0F, 4.0F, 10.0F, new class_5605(0.2F)),
