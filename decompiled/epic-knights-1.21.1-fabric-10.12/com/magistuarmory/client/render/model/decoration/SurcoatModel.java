...
public class SurcoatModel<T extends class_1309> extends ArmorDecorationModel<T> {
   public SurcoatModel(class_630 root) {
      super(root);
   }
   ...
   public static class_5607 createLayer() {
      ...
      partdefinition.method_32117(
         "body",
         class_5606.method_32108().method_32101(0, 0).method_32098(-5.0F, -1.0F, -3.5F, 10.0F, 19.0F, 7.0F, new class_5605(-0.4F)),
   ...
   public class_630[] getParts() {
      return new class_630[]{this.field_3391};
   }
}
