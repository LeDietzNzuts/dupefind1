...
public enum ModConfigValues {
   ...
   private ModConfigValues(final String entry, final Object defaultValue, final String comment) {
      this(entry, defaultValue, comment, Function.identity());
   }

   private ModConfigValues(final String entry, final Object defaultValue, final String comment, Function<Object, Object> entryFunction) {
      this.entry = entry;
