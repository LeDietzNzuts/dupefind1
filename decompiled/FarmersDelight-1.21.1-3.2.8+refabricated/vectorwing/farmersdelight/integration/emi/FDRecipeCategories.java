...
public class FDRecipeCategories {
   ...
   public static final EmiRecipeCategory COOKING = new EmiRecipeCategory(
      FarmersDelight.res("cooking"), FDRecipeWorkstations.COOKING_POT, simplifiedRenderer(0, 0)
   );
   public static final EmiRecipeCategory CUTTING = new EmiRecipeCategory(
      FarmersDelight.res("cutting"), FDRecipeWorkstations.CUTTING_BOARD, simplifiedRenderer(16, 0)
   );
   public static final EmiRecipeCategory DECOMPOSITION = new EmiRecipeCategory(
      FarmersDelight.res("decomposition"), FDRecipeWorkstations.ORGANIC_COMPOST, simplifiedRenderer(32, 0)
   );

   private static EmiRenderable simplifiedRenderer(int u, int v) {
      return (draw, x, y, delta) -> draw.method_25290(SIMPLIFIED_TEXTURES, x, y, u, v, 16, 16, 48, 16);
   }
}
