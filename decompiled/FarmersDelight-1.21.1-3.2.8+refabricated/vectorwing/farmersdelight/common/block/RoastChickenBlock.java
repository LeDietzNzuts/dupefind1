...
public class RoastChickenBlock extends FeastBlock {
   ...
   protected static final class_265 ROAST_SHAPE = class_259.method_1082(
      PLATE_SHAPE, class_2248.method_9541(4.0, 2.0, 4.0, 12.0, 9.0, 12.0), class_247.field_1366
   );

   public RoastChickenBlock(class_2251 properties, Supplier<class_1792> servingItem, boolean hasLeftovers) {
