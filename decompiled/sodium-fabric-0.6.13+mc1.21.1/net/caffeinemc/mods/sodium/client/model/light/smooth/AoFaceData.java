...
class AoFaceData {
   ...
   public void initLightData(LightDataAccess cache, class_2338 pos, class_2350 direction, boolean offset) {
      ...
      int adjZ;
      if (offset) {
         adjX = x + direction.method_10148();
         adjY = y + direction.method_10164();
         adjZ = z + direction.method_10165();
      } else {
         adjX = x;
         adjY = y;
         adjZ = z;
      ...
      class_2350[] faces = AoNeighborInfo.get(direction).faces;
