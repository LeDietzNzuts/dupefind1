...
public class OcclusionCuller {
   ...
   public OcclusionCuller(Long2ReferenceMap<RenderSection> sections, class_1937 level) {
   ...
   private void init(
      ...
      class_4076 origin = viewport.getChunkCoord();
      if (origin.method_10264() < this.level.method_32891()) {
         this.initOutsideWorldHeight(queue, viewport, searchDistance, frame, this.level.method_32891(), 0);
      } else if (origin.method_10264() >= this.level.method_31597()) {
         this.initOutsideWorldHeight(queue, viewport, searchDistance, frame, this.level.method_31597() - 1, 1);
      } else {
   ...
   private void initOutsideWorldHeight(WriteQueue<RenderSection> queue, Viewport viewport, float searchDistance, int frame, int height, int direction) {
      class_4076 origin = viewport.getChunkCoord();
      int radius = class_3532.method_15375(searchDistance / 16.0F);
   ...
   private RenderSection getRenderSection(int x, int y, int z) {
      return (RenderSection)this.sections.get(class_4076.method_18685(x, y, z));
   }
