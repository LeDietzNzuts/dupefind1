...
public class TranslucentGeometryCollector {
   ...
   public TranslucentGeometryCollector(class_4076 sectionPos) {
      ...
      if (this.quads.length <= 1) {
         ...
         if (sortBehavior.getSortMode() == SortBehavior.SortMode.NONE) {
            ...
            if (planeCount <= 1) {
               ...
               int attemptLimitIndex = class_3532.method_15340(normalCount, 2, STATIC_TOPO_SORT_ATTEMPT_LIMITS.length - 1);
