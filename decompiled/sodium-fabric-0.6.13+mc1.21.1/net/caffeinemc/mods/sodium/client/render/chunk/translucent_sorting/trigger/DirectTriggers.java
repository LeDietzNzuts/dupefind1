...
class DirectTriggers implements SortTriggering.SectionTriggers<DynamicTopoData> {
   ...
   public void integrateSection(SortTriggering ts, class_4076 sectionPos, DynamicTopoData data, CameraMovement movement) {
   ...
   private static class DirectTriggerData {
      ...
      DirectTriggerData(DynamicTopoData dynamicData, class_4076 sectionPos, Vector3dc triggerCameraPos) {
