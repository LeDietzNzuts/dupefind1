...
public class BakedModelEncoder {
   ...
   public static void writeQuadVertices(VertexBufferWriter writer, class_4665 matrices, ModelQuadView quad, int color, int light, int overlay, boolean colorize) {
