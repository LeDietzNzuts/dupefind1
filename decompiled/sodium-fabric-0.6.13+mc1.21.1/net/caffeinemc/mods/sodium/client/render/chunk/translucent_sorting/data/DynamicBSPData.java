...
public class DynamicBSPData extends DynamicData {
   ...
   private DynamicBSPData(class_4076 sectionPos, int vertexCount, BSPResult result, Vector3dc initialCameraPos, TQuad[] quads, int generation) {
   ...
   public static DynamicBSPData fromMesh(int vertexCount, CombinedCameraPos cameraPos, TQuad[] quads, class_4076 sectionPos, TranslucentData oldData) {
