...
public class EntityRenderer {
   ...
   public static void renderCuboid(class_4665 matrices, VertexBufferWriter writer, ModelCuboid cuboid, int light, int overlay, int color) {
   ...
   private static void prepareVertices(class_4665 matrices, ModelCuboid cuboid) {
      buildVertexPosition(CUBE_CORNERS[0], cuboid.x1, cuboid.y1, cuboid.z1, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[1], cuboid.x2, cuboid.y1, cuboid.z1, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[2], cuboid.x2, cuboid.y2, cuboid.z1, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[3], cuboid.x1, cuboid.y2, cuboid.z1, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[4], cuboid.x1, cuboid.y1, cuboid.z2, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[5], cuboid.x2, cuboid.y1, cuboid.z2, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[6], cuboid.x2, cuboid.y2, cuboid.z2, matrices.method_23761());
      buildVertexPosition(CUBE_CORNERS[7], cuboid.x1, cuboid.y2, cuboid.z2, matrices.method_23761());
   ...
   public static void prepareNormalsIfChanged(class_4665 matrices) {
      if (!matrices.method_23762().equals(lastMatrix)) {
         lastMatrix.set(matrices.method_23762());
         CUBE_NORMALS[0] = MatrixHelper.transformNormal(matrices.method_23762(), matrices.field_48930, class_2350.field_11033);
         CUBE_NORMALS[1] = MatrixHelper.transformNormal(matrices.method_23762(), matrices.field_48930, class_2350.field_11036);
         CUBE_NORMALS[3] = MatrixHelper.transformNormal(matrices.method_23762(), matrices.field_48930, class_2350.field_11043);
         CUBE_NORMALS[5] = MatrixHelper.transformNormal(matrices.method_23762(), matrices.field_48930, class_2350.field_11035);
         CUBE_NORMALS[4] = MatrixHelper.transformNormal(matrices.method_23762(), matrices.field_48930, class_2350.field_11039);
         CUBE_NORMALS[2] = MatrixHelper.transformNormal(matrices.method_23762(), matrices.field_48930, class_2350.field_11034);
