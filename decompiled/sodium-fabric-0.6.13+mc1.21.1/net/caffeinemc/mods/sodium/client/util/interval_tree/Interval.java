...
public abstract class Interval<T extends Comparable<? super T>> {
   ...
   public boolean equals(Object obj) {
      if (!(obj instanceof Interval<T> other)) {
         return false;
      } else if (this.start == null ^ other.start == null) {
         return false;
      } else if (this.end == null ^ other.end == null) {
         return false;
      } else if (this.isEndInclusive ^ other.isEndInclusive) {
         return false;
      } else if (this.isStartInclusive ^ other.isStartInclusive) {
         ...
         return this.start != null && !this.start.equals(other.start) ? false : this.end == null || this.end.equals(other.end);
      }
   }
