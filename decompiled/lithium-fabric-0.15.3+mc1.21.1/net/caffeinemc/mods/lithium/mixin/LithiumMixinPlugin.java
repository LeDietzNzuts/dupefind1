...
public class LithiumMixinPlugin implements IMixinConfigPlugin {
   private static final String[] MIXIN_PACKAGE_ROOTS = new String[]{
      "net.caffeinemc.mods.lithium.mixin.", "net.caffeinemc.mods.lithium.fabric.mixin.", "net.caffeinemc.mods.lithium.neoforge.mixin."
   };
   ...
   public void onLoad(String mixinPackage) {
      if (CONFIG == null) {
         try {
            ...
            throw new RuntimeException("Could not load configuration file for Lithium", var3);
         }

         this.logger
            .info("Loaded configuration file for Lithium: {} options available, {} override(s) found", CONFIG.getOptionCount(), CONFIG.getOptionOverrideCount());
      }
   }
   ...
   public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
      ...
      if (mixin == null) {
         this.logger
            .error("Expected mixin '{}' to start with any of these package roots '{}', treating as foreign and disabling!", mixinClassName, MIXIN_PACKAGE_ROOTS);
         return false;
      } else {
         ...
         if (option == null) {
            ...
            if (option.isOverridden()) {
               ...
               if (option.isEnabled()) {
                  this.logger.info("Force-enabling mixin '{}' as rule '{}' (added by {}) enables it", mixin, option.getName(), source);
               } else {
                  this.logger.info("Force-disabling mixin '{}' as rule '{}' (added by {}) disables it and children", mixin, option.getName(), source);
               }
            }
