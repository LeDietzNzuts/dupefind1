   ...
   public Iterator<E> iterator() {
      return new Iterator<E>() {
         ...
         public E next() {
            ...
            return (E)ReferenceMaskedList.this.allElements.get(index);
         }
      };
   }
      ...
      return new AbstractSpliterator<E>(Long.MAX_VALUE, 272) {
         ...
         public boolean tryAdvance(Consumer<? super E> action) {
            ...
            if (index == -1) {
               ...
               this.nextIndex = index + 1;
               action.accept((E)ReferenceMaskedList.this.allElements.get(index));
               return true;
            }
         }
      };
   ...
   public boolean add(E e) {
      ...
      if (oldIndex != -1) {
         throw new IllegalStateException(
            "MaskedList must not contain duplicates! Trying to add "
               + e
               + " but it is already present at index "
               + oldIndex
               + ". Current size: "
