...
public class PredicateFilterableList<T> extends ListeningList<T> {
   ...
   public PredicateFilterableList<T>.PredicateFilteredList getFiltered(Predicate<T> predicate) {
      ...
      return (PredicateFilterableList.PredicateFilteredList)this.predicateToFiltered
         .computeIfAbsent(predicate, x$0 -> new PredicateFilterableList.PredicateFilteredList(x$0));
   }
