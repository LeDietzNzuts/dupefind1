...
public class ChairEntity extends class_1297 {
   ...
   public ChairEntity(class_1299<?> entityType, class_1937 world) {
   ...
   public ChairEntity(class_1299<ChairEntity> entityType, class_1937 world, class_2338 pos, double doub) {
   ...
   public static class_9062 create(class_1937 world, class_2338 pos, double doub, class_1657 player) {
      if (!world.method_8608()) {
         class_1299<ChairEntity> entityType = MacawsFurniture.CHAIR_ENTITY_TYPE;
         List<ChairEntity> seatsAtPos = world.method_18023(entityType, new class_238(pos), entity -> entity.chair != null && entity.chair.equals(pos));
         if (seatsAtPos.isEmpty()) {
            ChairEntity chair = new ChairEntity(entityType, world, pos, doub);
   ...
   protected class_243 method_52533(class_1297 passenger, class_4048 dimensions, float scaleFactor) {
      return new class_243(0.0, dimensions.comp_2186() - 0.5F * scaleFactor, 0.0);
   }
