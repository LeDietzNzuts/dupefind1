...
public class IntegerSliderEntry extends TooltipListEntry<Integer> {
   ...
   private Function<Integer, class_2561> textGetter = integer -> class_2561.method_43470(String.format("Value: %d", integer));
   private final List<class_339> widgets;

   @Deprecated
   @Internal
   public IntegerSliderEntry(
      class_2561 fieldName, int minimum, int maximum, int value, class_2561 resetButtonKey, Supplier<Integer> defaultValue, Consumer<Integer> saveConsumer
   ) {
   ...
   public IntegerSliderEntry(
      ...
      this.sliderWidget = new IntegerSliderEntry.Slider(0, 0, 152, 20, ((double)this.value.get() - minimum) / Math.abs(maximum - minimum));
   ...
   public IntegerSliderEntry setTextGetter(Function<Integer, class_2561> textGetter) {
   ...
   public void setValue(int value) {
      this.sliderWidget.setValue((double)(class_3532.method_15340(value, this.minimum, this.maximum) - this.minimum) / Math.abs(this.maximum - this.minimum));
   ...
   public boolean isEdited() {
      return super.isEdited() || this.getValue().intValue() != this.orginial;
   }
   ...
   private class Slider extends class_357 {
      ...
      public void method_25346() {
         this.method_25355(IntegerSliderEntry.this.textGetter.apply(IntegerSliderEntry.this.value.get()));
      }

      protected void method_25344() {
         IntegerSliderEntry.this.value
            .set((int)(IntegerSliderEntry.this.minimum + Math.abs(IntegerSliderEntry.this.maximum - IntegerSliderEntry.this.minimum) * this.field_22753));
      }

      public boolean method_25404(int int_1, int int_2, int int_3) {
         return !IntegerSliderEntry.this.isEditable() ? false : super.method_25404(int_1, int_2, int_3);
      }

      public boolean method_25403(double double_1, double double_2, int int_1, double double_3, double double_4) {
         return !IntegerSliderEntry.this.isEditable() ? false : super.method_25403(double_1, double_2, int_1, double_3, double_4);
      }
