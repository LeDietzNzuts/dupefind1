...
public class DoubleFieldBuilder extends AbstractRangeFieldBuilder<Double, DoubleListEntry, DoubleFieldBuilder> {
   public DoubleFieldBuilder(class_2561 resetButtonKey, class_2561 fieldNameKey, double value) {
      super(resetButtonKey, fieldNameKey);
      this.value = value;
   }

   public DoubleFieldBuilder setErrorSupplier(Function<Double, Optional<class_2561>> errorSupplier) {
   ...
   public DoubleFieldBuilder setTooltipSupplier(Function<Double, Optional<class_2561[]>> tooltipSupplier) {
      return (DoubleFieldBuilder)super.setTooltipSupplier(tooltipSupplier);
   }

   public DoubleFieldBuilder setTooltipSupplier(Supplier<Optional<class_2561[]>> tooltipSupplier) {
      return (DoubleFieldBuilder)super.setTooltipSupplier(tooltipSupplier);
   }

   public DoubleFieldBuilder setTooltip(Optional<class_2561[]> tooltip) {
      return (DoubleFieldBuilder)super.setTooltip(tooltip);
   }

   public DoubleFieldBuilder setTooltip(class_2561... tooltip) {
      return (DoubleFieldBuilder)super.setTooltip(tooltip);
   }

   @NotNull
   public DoubleListEntry build() {
      DoubleListEntry entry = new DoubleListEntry(
