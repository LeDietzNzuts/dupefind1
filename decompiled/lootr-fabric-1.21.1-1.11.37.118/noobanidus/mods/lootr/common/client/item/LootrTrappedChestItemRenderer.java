...
public class LootrTrappedChestItemRenderer extends class_756 {
   ...
   public LootrTrappedChestItemRenderer(class_824 pBlockEntityRenderDispatcher, class_5599 pEntityModelSet) {
      ...
      this.blockEntity = new LootrTrappedChestBlockEntity(class_2338.field_10980, LootrRegistry.getTrappedChestBlock().method_9564());
   }
