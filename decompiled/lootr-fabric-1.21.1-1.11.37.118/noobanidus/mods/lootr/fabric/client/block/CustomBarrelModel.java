...
public class CustomBarrelModel implements class_1100 {
   ...
   public CustomBarrelModel(class_1100 opened, class_1100 unopened, @Nullable class_1100 vanilla) {
      this.opened = opened;
   ...
   public Collection<class_2960> method_4755() {
      if (this.dependencies == null) {
         Stream<class_2960> deps = Streams.concat(new Stream[]{this.opened.method_4755().stream(), this.unopened.method_4755().stream()});
         if (this.vanilla != null) {
            deps = Streams.concat(new Stream[]{deps, this.vanilla.method_4755().stream()});
         }
   ...
   public class_1087 method_4753(class_7775 modelBakery, Function<class_4730, class_1058> spriteGetter, class_3665 transform) {
      return new CustomBarrelModel.CustomBakedBarrelModel(
         this.opened.method_4753(modelBakery, spriteGetter, transform),
         this.unopened.method_4753(modelBakery, spriteGetter, transform),
         this.vanilla == null ? null : this.vanilla.method_4753(modelBakery, spriteGetter, transform)
      );
   }

   public static class CustomBakedBarrelModel implements class_1087, FabricBakedModel {
      private final class_1087 opened;
      private final class_1087 unopened;
      @Nullable
      private final class_1087 vanilla;

      public CustomBakedBarrelModel(class_1087 opened, class_1087 unopened, @Nullable class_1087 vanilla) {
         this.opened = opened;
         this.unopened = unopened;
         this.vanilla = vanilla;
      }
      ...
      public void emitBlockQuads(class_1920 blockView, class_2680 state, class_2338 pos, Supplier<class_5819> randomSupplier, RenderContext context) {
         ...
         class_1087 model = this.unopened;
      ...
      public List<class_777> method_4707(@Nullable class_2680 state, @Nullable class_2350 side, class_5819 rand) {
         return LootrAPI.isVanillaTextures() && this.vanilla != null
            ? this.vanilla.method_4707(state, side, rand)
            : this.unopened.method_4707(state, side, rand);
      }
