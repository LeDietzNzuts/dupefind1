...
public class LootrShulkerItemRenderer extends class_756 implements DynamicItemRenderer {
   ...
   public LootrShulkerItemRenderer(class_824 pBlockEntityRenderDispatcher, class_5599 pEntityModelSet) {
      ...
      this.tile = new LootrShulkerBlockEntity(class_2338.field_10980, LootrRegistry.getShulkerBlock().method_9564());
   }
