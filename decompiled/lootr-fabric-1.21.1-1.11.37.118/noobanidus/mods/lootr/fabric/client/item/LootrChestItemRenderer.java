...
public class LootrChestItemRenderer extends class_756 implements DynamicItemRenderer {
   ...
   public LootrChestItemRenderer(class_824 pBlockEntityRenderDispatcher, class_5599 pEntityModelSet) {
      ...
      this.tile = new LootrChestBlockEntity(class_2338.field_10980, LootrRegistry.getChestBlock().method_9564());
   }
