...
public class LampBamboo extends class_3749 {
   public static final class_2746 ON = class_2746.method_11825("on");
   private static final class_265 SHAPE_HANGING = class_2248.method_9541(2.0, 1.0, 2.0, 14.0, 12.0, 14.0);
   private static final class_265 SHAPE_STANDING = class_2248.method_9541(4.0, 0.0, 4.0, 12.0, 13.0, 12.0);

   public LampBamboo(class_2251 properties) {
      super(properties);
   ...
   protected void method_9515(class_2690<class_2248, class_2680> pBuilder) {
      ...
      pBuilder.method_11667(new class_2769[]{ON});
   }
