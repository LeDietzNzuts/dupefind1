...
public class NeoForgeToolFunctionsHelper implements ToolFunctionsHelper {
   ...
   public boolean isSword(ItemStack itemStack) {
      return itemStack.getItem() instanceof SwordItem
         ...
         || canPerformOneOfActions(itemStack, ItemAbilities.DEFAULT_SWORD_ACTIONS);
   }
   ...
   public boolean isPickaxe(ItemStack itemStack) {
      return itemStack.getItem() instanceof PickaxeItem
         ...
         || canPerformOneOfActions(itemStack, ItemAbilities.DEFAULT_PICKAXE_ACTIONS);
   }
   ...
   public boolean isShovel(ItemStack itemStack) {
      return itemStack.getItem() instanceof ShovelItem
         ...
         || canPerformOneOfActions(itemStack, ItemAbilities.DEFAULT_SHOVEL_ACTIONS);
   }
