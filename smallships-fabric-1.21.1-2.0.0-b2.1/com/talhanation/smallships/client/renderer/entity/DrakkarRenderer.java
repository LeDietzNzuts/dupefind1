...
public class DrakkarRenderer extends ShipRenderer<DrakkarEntity> {
   public DrakkarRenderer(class_5618 context) {
      super(context);
   }

   protected DrakkarModel createBoatModel(class_5618 context, class_1692 type) {
      return new DrakkarModel(context.method_32167(DrakkarModel.LAYER_LOCATION));
   }
   ...
   public void render(
      @NotNull DrakkarEntity drakkarEntity,
      float entityYaw,
      float partialTicks,
