...
public class VectorMath {
   ...
   public static class_243 toVec3(Vector3d v) {
      return new class_243(v.x, v.y, v.z);
   }

   public static class_243 toVec3(Vector3f v) {
      return new class_243(v.x, v.y, v.z);
   }
   ...
   public static Vector3d getRandGaussian(class_5819 random) {
      return new Vector3d(random.method_43059(), random.method_43059(), random.method_43059());
   }
}
