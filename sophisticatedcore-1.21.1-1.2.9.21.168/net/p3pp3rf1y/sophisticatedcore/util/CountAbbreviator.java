...
public class CountAbbreviator {
   ...
   private static final DecimalFormat ONE_DIGIT_PRECISION = new DecimalFormat("##.0", ROOT_LOCALE_FORMAT_SYMBOLS);
   ...
   public static String abbreviate(int count, int maxCharacters) {
      ...
      if (digits <= maxCharacters) {
         ...
         double divisionResult = count / Math.pow(1000.0, thousandsExponent);
